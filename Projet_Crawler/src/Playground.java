...
public class Playground {
    ...
    public Playground (String pathName){
        try{
            ...
            final Image imageGrassTwo = ImageIO.read(new File("./img/grass2.png"));
            final Image imagePortail = ImageIO.read(new File("./img/flag.png"));
            ...
            final int imageGrassTwoWidth = imageGrassTwo.getWidth(null);
            final int imageGrassTwoHeight = imageGrassTwo.getHeight(null);
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)){
                    switch (element){
                        ...
                        case 'R' : environment.add(new SolidSprite(columnNumber*imageRockWidth,
                            ...
                            break;
                        case 'A' : environment.add(new Sprite(columnNumber*imageGrassTwoWidth,
                                lineNumber*imageGrassTwoHeight, imageGrassTwo, imageGrassTwoWidth, imageGrassTwoHeight));
                            break;
                        case '.':
                            Sprite exit = new Sprite(columnNumber * imagePortailWidth,
                                    lineNumber * imagePortailHeight, imagePortail, imagePortailWidth, imagePortailHeight);
                            exit.setExit();
                            environment.add(exit);
                            break;
                        case 'P':
                            Sprite trap = new Sprite(columnNumber * imageTrapWidth,
